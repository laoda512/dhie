...
public class QaAdapter2 extends BaseAdapter {
	List<QA> qsList;
	Context mContext;
	LayoutInflater mLayoutInflater;
	public QaAdapter2(List<QA> qsList,Context c) {
		this.qsList = qsList;
		this.mContext=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView = mLayoutInflater.inflate(R.layout.listitem_qa2, null);
		...
		mViewholder.v1.setFocusable(false);
		mViewholder.v1.setClickable(false);
