...
public class ShowContentFragment extends BaseFragment  {
	...
	public static ShowContentFragment newInstance() {
		ShowContentFragment details = new ShowContentFragment();
	...
	public void iniView() {
		...
		if(currentQA.getAnswer()!=null){
			String content = currentQA.getAnswer().replace("@_enter", "\n");
