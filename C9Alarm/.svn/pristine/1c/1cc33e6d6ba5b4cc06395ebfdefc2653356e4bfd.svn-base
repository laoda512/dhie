...
public class ADListFragment extends BaseFragment {
	...
	public static ADListFragment newInstance(String formId) {
		ADListFragment details = new ADListFragment();
...
View bottomBackground;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		bottomBackground = findViewById(R.id.bottomBack);
	//	bottomBackground.setVisibility(View.VISIBLE);
	//	bottomBackground.setBackgroundResource(R.drawable.ad_ad);
		// preparing list data
		prepareListData();
	...
	private void prepareListData() {
		...
		// Adding child data
		listDataHeader.add("街头小广告");
		listDataHeader.add("应用墙");
...
//		List<String> comingSoon = new ArrayList<String>();
	...
	class ExpandableListAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(int groupPosition, final int childPosition,
			...
			final RelativeLayout rlMain = (RelativeLayout) convertView
			...
			if (groupPosition == 0 && childPosition == 0) {
				...
				if(getActivity()!=null)
					ADManager.addBanner(rlMain, getActivity(),null);
			//	ADManager.addBanner(rlMain, AlarmApplication.getApp(),null);
//				convertView.setOnClickListener(new OnClickListener() {
//					@Override
//					public void onClick(View v) {
//						//DiyManager.showRecommendWall(getActivity());  
//						//OffersManager.showOffers(getActivity());
//						SmartBannerManager.show(getActivity());
//					}
//				});
				
				txtListChild.setText("正在张贴小广告...");
				value.setText("什么？一针包治？");
			} else if (groupPosition == 0 && childPosition == 1) {
				LinearLayout l =new LinearLayout(AlarmApplication.getApp());
				...
				ADManager.addYoumiBanner(AlarmApplication.getApp(),l);
//				txtListChild.setText("正在张贴小广告...");
				value.setText("什么？一针包治？");
				...
				if(AlarmApplication.getApp().getFLock().isBaiduBannerOn()==true) {
				txtListChild.setText("点击开启应用推荐");
				value.setText(AlarmApplication.getApp().getUserNickName());
				convertView.setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						if(getActivity()!=null)
					//	OffersManager.getInstance(getActivity()).showOffersWallDialog(getActivity());
						//DiyManager.showRecommendWall(getActivity());  
						
						com.tavx.C9Alarm.bw.OffersManager.showOffers(getActivity());
					}
				});
				
				}else{
					txtListChild.setText("暂无广告，敬请期待下个版本");
				}
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			if(groupPosition==0)
			lefthint.setText("每小时最多一次");
			if(groupPosition==1)
			lefthint.setText("次数不限");
