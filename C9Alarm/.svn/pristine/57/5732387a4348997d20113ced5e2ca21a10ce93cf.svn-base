 ...
 *
 */
public class ADBean extends readWriteAbleBean{
	 ...
	 * @param _tag
	 */
	public ADBean(Context c, String _tag) {
		super(c, _tag);
	...
	public String toString() {
		return "ADBean [count=" + count + ", date=" + date + ", MAX_COUNT="
				+ MAX_COUNT + "]";
	}
