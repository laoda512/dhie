...
public class MySwitch extends CompoundButton {
    ...
    public Drawable getmLeftBackground() {
		return mLeftBackground;
	}

	public void setmLeftBackground(Drawable mLeftBackground) {
		this.mLeftBackground = mLeftBackground;
	}

	public Drawable getmRightBackground() {
		return mRightBackground;
	}

	public void setmRightBackground(Drawable mRightBackground) {
	...
	public void setmTrackDrawable(Drawable mTrackDrawable) {
		this.mTrackDrawable = mTrackDrawable;
	/*	Log.e("aaaa", "setmTrackDrawable");
    ...
    */
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        if (commitChange) {
			...
			Log.e("aaaa", "mnmm" + mThumbPosition);
			
			if (fixed)
				if (this.mOnChangeAttemptListener != null) {
/**
 * edit by @author Wangcheng 
 * make mOnChangeAttemptListener send true when sliding over in slide mode 
 * */
					boolean lc = false;
					if (isChecked()) {
						lc=true;
					}
					int pos = lc ? getThumbScrollRange() : 0;
					Log.e("aaaa", "mnmm" + mThumbPosition+" "+pos);
					if (mThumbPosition == pos) {
						this.mOnChangeAttemptListener.onChangeAttempted(true);
					} else {
						this.mOnChangeAttemptListener.onChangeAttempted(false);
					}
				}
			animateThumbToCheckedState(isChecked());
		}
    ...
    */
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	Log.e("aaaa", "on measure"+widthMeasureSpec+" "+heightMeasureSpec);
