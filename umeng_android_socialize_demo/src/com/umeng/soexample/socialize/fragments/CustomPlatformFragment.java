...
public class CustomPlatformFragment extends Fragment implements OnClickListener {
	...
	private void configSso() {
		...
		vedio.setThumb(new UMImage(getActivity(), BitmapFactory.decodeResource(
		...
		sinaContent.setShareContent("友盟社会化分享组件" + new Date().toString());
	...
	private void addLaiWang() {
		...
		final UMImage laiwangImg = new UMImage(getActivity(),
				R.drawable.device);
...
//		platforms.add(SHARE_MEDIA.LAIWANG);
	...
	private void addWXPlatform() {
		...
		mController.getConfig().registerListener(new SnsPostListener() {
			...
			@Override
			public void onStart() {
				Toast.makeText(getActivity(), "weixin -- xxxx onStart", 0).show();
			}

			@Override
			public void onComplete(SHARE_MEDIA platform, int eCode,
					SocializeEntity entity) {
				Toast.makeText(getActivity(), platform + " code = " + eCode, 0)
						.show();
			}
		});
		...
		// mController.postShare(getActivity(), SHARE_MEDIA.WEIXIN, new
		// SnsPostListener() {
		//
		// @Override
		// public void onStart() {
		...
		// Toast.makeText(getActivity(), "微信或者微信朋友圈分享完成啦",
		// Toast.LENGTH_SHORT).show();
		// } else {
		// Toast.makeText(getActivity(), "微信或者微信朋友圈分享失败...",
		// Toast.LENGTH_SHORT).show();
		// }
		// }
		// });
	...
	private void addYXPlatform() {
		...
		mController.getConfig().registerListener(new SnsPostListener() {
			...
			@Override
			public void onStart() {
				Toast.makeText(getActivity(), "yixin onStart",
						Toast.LENGTH_SHORT).show();
			}
			...
			public void onComplete(SHARE_MEDIA platform, int eCode,
					SocializeEntity entity) {
				Toast.makeText(getActivity(), platform + "onComplete   ---- ." + eCode,
						Toast.LENGTH_SHORT).show();
			}
		});
		...
		// mController.directShare(getActivity(), SHARE_MEDIA.YIXIN, new
		// SnsPostListener() {
		//
		// @Override
		// public void onStart() {
		...
		// SocializeEntity entity) {
		// if ( eCode == StatusCode.ST_CODE_SUCCESSED ) {
		// Toast.makeText(getActivity(), "yixin done成功.",
		// Toast.LENGTH_SHORT).show();
		// } else {
		// Toast.makeText(getActivity(), "yixin 失败.",
		// Toast.LENGTH_SHORT).show();
		// }
		// }
		// }) ;
	...
	private void addFacebook() {
		...
		UMImage mUMImgBitmap = new UMImage(getActivity(), new File(
				"/mnt/sdcard/test.jpg"));
		// UMImage mUMImgBitmap = new UMImage(getActivity(),
		// BitmapFactory.decodeResource(
		// getResources(), R.drawable.device));
		...
		// mController.doOauthVerify(getActivity(), SHARE_MEDIA.FACEBOOK, new
		// UMAuthListener() {
		//
		// @Override
		// public void onStart(SHARE_MEDIA platform) {
		// Toast.makeText(getActivity(), "开始授权   2222",
		// Toast.LENGTH_SHORT).show();
		// }
		//
		// @Override
		// public void onError(SocializeException e, SHARE_MEDIA platform) {
		// Toast.makeText(getActivity(), "授权失败 2222",
		// Toast.LENGTH_SHORT).show();
		// }
		//
		// @Override
		// public void onComplete(Bundle value, SHARE_MEDIA platform) {
		// Toast.makeText(getActivity(), "授权完成 2222",
		// Toast.LENGTH_SHORT).show();
		// }
		//
		// @Override
	...
	private void addInstagram() {
		...
		// mController.directShare(getActivity(), SHARE_MEDIA.INSTAGRAM, new
		// SnsPostListener() {
		//
		// @Override
		// public void onStart() {
		...
		// public void onComplete(SHARE_MEDIA platform, int eCode,
		// SocializeEntity entity) {
		// Toast.makeText(getActivity(), "instagram分享成功.",
		// Toast.LENGTH_SHORT).show();
		// }
		// });
	}
